...
char** vetAllocString(int tamanhoVet) {
	char** vetAlloc = (char**)malloc(tamanhoVet * sizeof(char*)); // Aloque mem�ria para o vetor de ponteiros
...
int main() {
	...
	char conteudo[MAX_WORDS][MAX_WORDS] = { "Brunhild", "Sigrun", "Hilde", "Gudrun", "Brynhildr", "Svava", "Herja", "Geirav�r", "R��gr��r", "Reginleif", "Herv�r alvitr", "Hj�r�rimul", "Skuld", "Hildr", "Geirsk�gul", "Randgr��r", "��gn", "Hla�gunnr", "Sanngr��r", "Sk�gul" };
